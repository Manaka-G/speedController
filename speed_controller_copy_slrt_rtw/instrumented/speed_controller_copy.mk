...
MODEL           = speed_controller_copy
MODULES         = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c speed_controller_copy_capi.c speed_controller_copy_data.c speed_controller_copy_xcp.c speed_controller_copy_xcp_TET.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = speed_controller_copy.mk
...
S_FUNCTIONS     = sg_IO101_da_s.c sg_IO101_setup_s.c sg_IO106_ad_s.c sg_IO106_setup_s.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Program Files\MATLAB\R2017b\bin\win64\mexopts\msvc2017.xml"
...
MODELLIB                  = speed_controller_copylib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = speed_controller_copy_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\speed_controller_copy_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\analog\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\common
...
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\common\sglibc_MSVC140_vc.lib
!else
LIBS = $(LIBS) sglibc_MSVC140.lib
!endif 
...
MODULES_sglibc_MSVC140 = \
	dummy.obj \


sglibc_MSVC140.lib : rtw_proj.tmw $(MAKEFILE) $(MODULES_sglibc_MSVC140)
	@cmd /C "echo ### Creating $@"
	$(LIBCMD) /nologo /out:$@ $(MODULES_sglibc_MSVC140)
	@cmd /C "echo ### Created $@"

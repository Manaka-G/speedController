...
#ifndef RTW_HEADER_speed_controller_copy_h_
#define RTW_HEADER_speed_controller_copy_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef speed_controller_copy_COMMON_INCLUDES_
# define speed_controller_copy_COMMON_INCLUDES_
...
#include "xpcimports.h"
#endif                                 /* speed_controller_copy_COMMON_INCLUDES_ */

#include "speed_controller_copy_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_speed_controller_copy  RT_MODEL_speed_controller_copy_T

/* Definition for use in the target main file */
#define speed_controller_copy_rtModel  RT_MODEL_speed_controller_copy_T
...
typedef struct {
  state BusConversion_InsertedFor_contr;
  ...
  real_T tStance_out_k;                /* '<S1>/State Determination' */
  real_T walkMode[2];                  /* '<S1>/Control modes' */
} B_speed_controller_copy_T;
...
} DW_speed_controller_copy_T;

/* Backward compatible GRT Identifiers */
#define rtB                            speed_controller_copy_B
#define BlockIO                        B_speed_controller_copy_T
#define rtP                            speed_controller_copy_P
#define Parameters                     P_speed_controller_copy_T
#define rtDWork                        speed_controller_copy_DW
#define D_Work                         DW_speed_controller_copy_T

/* Parameters (auto storage) */
struct P_speed_controller_copy_T_ {
  ...
  real_T Gain3_Gain;                   /* Expression: 1
                                        ...
                                        */
  real_T Gain3_Gain_p;                 /* Expression: 500
...
struct tag_RTM_speed_controller_copy_T {
  const char_T *path;
...
extern P_speed_controller_copy_T speed_controller_copy_P;

/* Block signals (auto storage) */
extern B_speed_controller_copy_T speed_controller_copy_B;

/* Block states (auto storage) */
extern DW_speed_controller_copy_T speed_controller_copy_DW;

/* External data declarations for dependent source files */
extern const real_T speed_controller_copy_RGND;/* real_T ground */

/*====================*
 * External functions *
 *====================*/
extern speed_controller_copy_rtModel *speed_controller_copy(void);
...
extern RT_MODEL_speed_controller_copy_T *const speed_controller_copy_M;
 ...
 *
 * '<Root>' : 'speed_controller_copy'
 * '<S1>'   : 'speed_controller_copy/Sensor Read and Process'
 * '<S2>'   : 'speed_controller_copy/controller1'
 * '<S3>'   : 'speed_controller_copy/Sensor Read and Process/Control modes'
 * '<S4>'   : 'speed_controller_copy/Sensor Read and Process/GUI'
 * '<S5>'   : 'speed_controller_copy/Sensor Read and Process/Scopes'
 * '<S6>'   : 'speed_controller_copy/Sensor Read and Process/State Determination'
 * '<S7>'   : 'speed_controller_copy/Sensor Read and Process/Zero Level Treadmill'
 * '<S8>'   : 'speed_controller_copy/Sensor Read and Process/measureSubjWeight'
 * '<S9>'   : 'speed_controller_copy/Sensor Read and Process/Scopes/Scope 4'
 * '<S10>'  : 'speed_controller_copy/Sensor Read and Process/Scopes/Scope 6'
 * '<S11>'  : 'speed_controller_copy/Sensor Read and Process/Zero Level Treadmill/Zero Level Force Plates'
 */
#endif                                 /* RTW_HEADER_speed_controller_copy_h_ */

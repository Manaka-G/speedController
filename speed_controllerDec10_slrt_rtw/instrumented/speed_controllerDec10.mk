...
MODEL           = speed_controllerDec10
MODULES         = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c speed_controllerDec10_capi.c speed_controllerDec10_data.c speed_controllerDec10_xcp.c speed_controllerDec10_xcp_TET.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = speed_controllerDec10.mk
...
MODELLIB                  = speed_controllerDec10lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = speed_controllerDec10_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\speed_controllerDec10_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
